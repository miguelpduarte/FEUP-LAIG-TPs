 ...
 * @constructor
 */
class King extends PrimitiveObject {
	...
	display() {
        this.scene.pushMatrix();
            this.scene.translate(0, 2.545, 0);
            this.scene.rotate(Math.PI/2, 0, 0, 1);
            this.scene.scale(0.06, 0.2, 0.04);
            this.cube.display();
        this.scene.popMatrix();
        this.scene.pushMatrix();
            this.scene.translate(0, 2.52, 0);
            this.scene.scale(0.06, 0.23, 0.04);
            this.cube.display();
        this.scene.popMatrix();  
        this.scene.pushMatrix();
        ...
        this.scene.popMatrix(); 
        this.scene.pushMatrix();
            this.scene.translate(0, 1.68, 0);
            this.piece_wave2.display();
            this.scene.rotate(Math.PI, 0, 1, 0);
            this.piece_wave2.display();
        this.scene.popMatrix();  
        this.scene.pushMatrix();
            this.scene.translate(0, 1.76, 0);
            this.piece_wave3.display();
            this.scene.rotate(Math.PI, 0, 1, 0);
            this.piece_wave3.display();
        this.scene.popMatrix();
        this.scene.pushMatrix();
            this.scene.translate(0, 1.82, 0);
            this.head.display();
            this.scene.rotate(Math.PI, 0, 1, 0);
            this.head.display();
        this.scene.popMatrix();  
        this.scene.pushMatrix();
            this.scene.translate(0, 2.37, 0);
            this.piece_wave4.display();
            this.scene.rotate(Math.PI, 0, 1, 0);
            this.piece_wave4.display();
        this.scene.popMatrix();
        this.scene.pushMatrix();
    ...
    createPieceWave1() {
		...
		[	// U0
            [				 
                ...
                [-width*13/10, height/2, 0.0, 1.0 ],        // V1
                [-width, height, 0.0, 1.0 ]       // V2
            ],
            // U1
            [
                [-width, 0.0, width*4/3, 1.0 ],   // V0
                [-width*13/10, height/2, width*13/10*4/3, 1.0 ],   // V1
                [-width, height, width*4/3, 1.0 ]	// V2					 
            ],
            // U2
            [			
                [ width, 0.0, width*4/3, 1.0 ],   // V0
    ...
    createPieceWave2() {
		...
		[	// U0
            [				 
                [-width, 0.0, 0.0, 1.0 ],        // V0
                [-width*7/4, height/2, 0.0, 1.0 ],        // V1
                [-width, height, 0.0, 1.0 ]       // V2
            ],
            // U1
            [
                [-width, 0.0, width*4/3, 1.0 ],   // V0
                [-width*7/4, height/2, width*7/4*4/3, 1.0 ],   // V1
                [-width, height, width*4/3, 1.0 ]	// V2					 
            ],
            // U2
            [			
    ...
    createPieceWave3() {
		...
		[	// U0
            [				 
                [-width, 0.0, 0.0, 1.0 ],        // V0
                [-width*5/4, height/2, 0.0, 1.0 ],        // V1
                [-width, height, 0.0, 1.0 ]       // V2
            ],
            // U1
            [
                [-width, 0.0, width*4/3, 1.0 ],   // V0
                [-width*5/4, height/2, width*5/4*4/3, 1.0 ],   // V1
                [-width, height, width*4/3, 1.0 ]	// V2					 
            ],
            // U2
            [			
    ...
    createPieceWave4() {
		...
		[	// U0
            [				 
                [-width, 0.0, 0.0, 1.0 ],        // V0
                [-width*5/4, height*9/10, 0.0, 1.0 ],        // V1
                [ 0.0, height, 0.0, 1.0 ]       // V2
            ],
            // U1
            [
                [-width, 0.0, width*4/3, 1.0 ],   // V0
                [-width*5/4, height*9/10, width*5/4*4/3, 1.0 ],   // V1
                [ 0.0, height, 0.0, 1.0 ]	// V2					 
            ],
            // U2
            [			
		...
		this.piece_wave4 = this.createNurbsObject(3, 2, control_vertexes, 20, 20);
    }

    createHead() {
        let base_radius = 0.15;
        let base_height = 0.5;
		...
		[	// U0
            [				 
                [-base_radius, 0.0, 0.0, 1.0 ],        // V0
                [-base_radius*26/10, base_height*8/10, 0.0, 1.0 ],        // V1
                [-base_radius*24/10, base_height, 0.0, 1.0 ],       // V2
                [-base_radius*1/2, base_height*11/10, 0.0, 1.0 ]       // V3
            ],
            // U1
            [
                [-base_radius, 0.0, base_radius*4/3, 1.0 ],   // V0
                [-base_radius*26/10, base_height*8/10, base_radius*26/10*4/3, 1.0 ],   // V1
		        [-base_radius*24/10, base_height, base_radius*24/10*4/3, 1.0 ],   // V2			
		        [-base_radius*1/2, base_height*11/10, base_radius*1/2*4/3, 1.0 ]   // V3				 
            ],
            // U2
            [			
                [ base_radius, 0.0, base_radius*4/3, 1.0 ],   // V0
		...
		this.head = this.createNurbsObject(3, 3, control_vertexes, 40, 40);
    }

    createCross() {
        this.cube = new Cube(this.scene, 4, this.createNurbsObject);
    }

    createBottom() {
        this.bottom = new Circle(this.scene, 60);
    }
};